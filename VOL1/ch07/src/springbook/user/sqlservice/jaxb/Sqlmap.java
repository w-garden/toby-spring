...
// 생성 날짜: 2024.01.10 시간 10:42:14 PM KST 
//
...
@XmlRootElement(name = "sqlmap") //반환 작업에서 참고할 정보를 애노테이션으로 갖고있음
public class Sqlmap {

    @XmlElement(required = true)
    protected List<SqlType> sql; //<sql> 태그의 정보를 Sqltype 오브젝트를 리스트로 갖고 있다.
