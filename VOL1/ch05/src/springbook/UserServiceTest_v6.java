...
import springbook.user.service.UserService_v6;
...
public class UserServiceTest_v6 {
    @Autowired
    DataSource dataSource;
    @Autowired
    private UserService_v6 userService;
    @Autowired
    ...
    static class TestUserService extends UserService_v6 {
        private String id;
    ...
    public void upgradeAllOrNothing() throws Exception {
        UserService_v6 testUserService = new TestUserService(users.get(3).getId());
